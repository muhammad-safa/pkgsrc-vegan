...
PKG_SUPPORTED_OPTIONS=	heif jxl libimagequant raqm tiff x11
PKG_SUGGESTED_OPTIONS=	libimagequant raqm tiff jxl

.include "../../mk/bsd.options.mk"

.if !empty(PKG_OPTIONS:Mheif)
.include "../../graphics/libheif/buildlink3.mk"
CONFIGURE_ARGS+=	--with-heif=${BUILDLINK_PREFIX.libheif}
.else
...
CONFIGURE_ARGS+=	--with-jxl=${BUILDLINK_PREFIX.libjxl}
.else
